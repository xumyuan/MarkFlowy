/// Graphite Light 主题（石墨浅色主题）
/// 参考: marktext/src/renderer/src/assets/themes/graphite.theme.css
///
/// 以蓝灰色为主调的清新浅色主题，搭配深色侧边栏
library;

import 'package:flutter/material.dart';

/// Graphite Light 主题颜色常量
class GraphiteLightColors {
  GraphiteLightColors._();
  ...
  static const Color editorText = Color(0xB32B3032);
  static const Color editorTextStrong = Color(0xCC2B3032);
  ...
  static const Color blockquoteText = Color(0x802B3032);
  static const Color hrColor = Color(0x1A2B3032);
  static const Color strongColor = Color(0xCC2B3032);
  static const Color emColor = Color(0xFF5F9EA0);
  static const Color listMarkerColor = Color(0xFF6886AA);

  // 侧边栏
  static const Color sideBarBg = Color(0xFF454B50);
  static const Color sideBarText = Color(0x66BCC1C5);
